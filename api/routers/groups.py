...
async def add_group_item(
    ...
    item_id = await db_groups.add_group_item(group_id, item_name, qty, user_id)
    rows = await db_groups.get_group_items(group_id)
...
async def delete_group_item(
    ...
    # Poate șterge doar cel care l-a adăugat sau owner-ul grupului
...
# ---------------------------------------------------------------------------
# DELETE /api/groups/{group_id}/items/clear
# ---------------------------------------------------------------------------
